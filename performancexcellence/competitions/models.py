...
class Competition(models.Model):
    ...
    competition_category = models.CharField(max_length=10, choices=competition_category_choices, null=True)
    world_athletics_points = models.IntegerField(blank=True, null=True)

    def __str__(self):
        return f"{self.athlete.first_name} {self.athlete.last_name} - {self.competition_name}"
